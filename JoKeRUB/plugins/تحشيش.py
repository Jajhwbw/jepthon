...
async def permalink(mention):
    ...
    if user.id == 627658332: 
        return await edit_or_reply(mention, f"**- دول اصحاب السورس**")
    if user.id == 7098821848 :      
        return await edit_or_reply(mention, f"**- دول اصحاب السورس **") 
    if user.id == 6300938349:       
        return await edit_or_reply(mention, f"**- دول السورس اصحاب**")
...
lMl10l = [7098821848, 6300938349, 627658332]
    ...
    if event.reply_to and event.sender_id in lMl10l:
       ...
       if owner_id == l313l.uid:
           if event.message.message == "منصب؟":
               ...
               await event.reply("**سيدنا محمد عليه الصلاة والسلام ❤️**")
           elif event.message.message == "مين تاج راسك":
               await event.reply("** زين @Ze_in22 تاج راسي ❤️**")           
           elif event.message.message == "انت اي":
               await event.reply("** اني فيل بزلومه وي وي**")
