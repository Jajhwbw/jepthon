...
joker_users = []
joker_mute = "https://graph.org/file/bb555eb91c0ac90e7f67e.jpg"
joker_unmute = "https://graph.org/file/c7cbc815f5f8b36488e4b.jpg"
...
async def mutejep(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 7098821848:
            return await edit_delete(event, "** دي . . لا يمڪنني كتـم مرات صـاحب السـورس  ╰**")    
        if event.chat_id == 627658332:
            return await edit_delete(event, "** دي . . لا يمڪنني كتـم اخو صـاحب السـورس  ╰**")        
        try:
        ...
        if user.id == 7098821848:
            return await edit_or_reply(event, "** دي . . لا يمڪنني كتـم مرات صـاحب السـورس  ╰**")    
        if user.id == 627658332:
            return await edit_or_reply(event, "** دي . . لا يمڪنني كتـم اخو صـاحب السـورس  ╰**")        
