#all write Codes By Team Aljoker @ucriss
#By Hussein @lMl10l
import asyncio
import random
import re
...
async def aljoker313(joker313):
  ...
  await joker313.client.send_file(joker313.chat_id,url,caption="᯽︙ BY : @ucriss 🎀",parse_mode="html")
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="᯽︙ BY : @ucriss 🎀",parse_mode="html")
  await vois.delete()
@l313l.on(admin_cmd(outgoing=True, pattern="قران$"))
async def jepvois(vois):
  rl = random.randint(2,101)
  url = f"https://t.me/QuraanJep/{rl}"
  await vois.client.send_file(vois.chat_id,url,caption="᯽︙ BY : @ucriss 🤲🏻☪️",parse_mode="html")
  await vois.delete()
@l313l.on(admin_cmd(outgoing=True, pattern="ثيم$"))
async def jepThe(theme):
  rl = random.randint(2,510)
  url = f"https://t.me/GSSSD/{rl}"
  await theme.client.send_file(theme.chat_id,url,caption="᯽︙ THEME BY : @ucriss 🎊",parse_mode="html")
  await theme.delete()
